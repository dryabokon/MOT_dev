...
# ----------------------------------------------------------------------------------------------------------------------
    def init_model_LPVD(self):
        self.model_LPVD = YOLO('./models/LPVD_yolo8n_ReLU_21_640_041223.pt')
        self.model_LPVD.to(self.device)
        return
# ----------------------------------------------------------------------------------------------------------------------
    def init_model_symb(self):
        self.model_symb = YOLO('./models/Symb_yolo8_relu_stacked_200_224_210324.pt')
        self.model_symb.to(self.device)
        return
# ----------------------------------------------------------------------------------------------------------------------
    def init_model_LP_type(self):
        self.model_LP_type = torch.load('./models/yolov8n_LP_type_usa_rgb_v6.pt')['model']
...
# ----------------------------------------------------------------------------------------------------------------------
    def init_model_MMR(self):
        ...
        self.ort_sess_MMR = InferenceSession('./models/MMR_2700&truck_35_224_180324.onnx')

        with open('./models/MMR_2700&truck_35_224_180324.json') as f:
...
# ----------------------------------------------------------------------------------------------------------------------
    def init_model_color(self):
        self.ort_sess_color = InferenceSession('./models/color_resnet_relu_30_224_170324.onnx')
        with open('./models/color_resnet_relu_30_224_170324.json') as f:
